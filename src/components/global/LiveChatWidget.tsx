      ...
      {!open && (
        <>
          <a
            ...
            className="fixed bottom-[5.5rem] left-4 z-50 inline-flex items-center gap-2 pl-2 pr-3 h-11 rounded-full shadow-lg text-white text-sm font-semibold hover:opacity-95 transition-all hover:scale-105 animate-fade-in"
          ...
          >
            ...
            <span className="animate-pulse">Join Channel</span>
          </a>
