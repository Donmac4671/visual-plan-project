...
export const networks: Network[] = [
  {
    ...
    bundles: [
      { size: "1GB", sizeGB: 1, price: 4.40, generalPrice: 4.40 },
      { size: "2GB", sizeGB: 2, price: 8.80, generalPrice: 8.80 },
      { size: "3GB", sizeGB: 3, price: 13.20, generalPrice: 13.20 },
      { size: "4GB", sizeGB: 4, price: 17.60, generalPrice: 17.60 },
      { size: "5GB", sizeGB: 5, price: 22.00, generalPrice: 22.00 },
      { size: "6GB", sizeGB: 6, price: 26.40, generalPrice: 26.40 },
      { size: "7GB", sizeGB: 7, price: 30.80, generalPrice: 30.80 },
      { size: "8GB", sizeGB: 8, price: 35.20, generalPrice: 35.20 },
      { size: "10GB", sizeGB: 10, price: 43.00, generalPrice: 43.00 },
      { size: "15GB", sizeGB: 15, price: 63.00, generalPrice: 63.00 },
      { size: "20GB", sizeGB: 20, price: 83.00, generalPrice: 83.00 },
      { size: "25GB", sizeGB: 25, price: 105.00, generalPrice: 105.00 },
      { size: "30GB", sizeGB: 30, price: 126.00, generalPrice: 126.00 },
      { size: "40GB", sizeGB: 40, price: 163.00, generalPrice: 163.00 },
      { size: "50GB", sizeGB: 50, price: 202.00, generalPrice: 202.00 },
    ],
  },
  {
    id: "telecel",
  ...
  },
  {
    ...
    bundles: [
      ...
      { size: "12GB", sizeGB: 12, price: 49.00, generalPrice: 49.00 },
      { size: "15GB", sizeGB: 15, price: 62.00, generalPrice: 62.00 },
      { size: "20GB", sizeGB: 20, price: 81.00, generalPrice: 81.00 },
      { size: "25GB", sizeGB: 25, price: 103.00, generalPrice: 103.00 },
      { size: "30GB", sizeGB: 30, price: 122.00, generalPrice: 122.00 },
    ],
  },
];
